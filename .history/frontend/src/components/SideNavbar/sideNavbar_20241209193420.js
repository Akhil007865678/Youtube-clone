      ...
      <div className={sideNavbar ? 'home-sideNavbar' : 'homeSideNavbarHide'}>
        <div className='home_sideNavbarTop'>
            <div className={`home_sideNavbarTopOption`}>
                <HomeIcon/>
                <Link to={'/'} style={{ textDecoration: 'none', color: 'inherit', display: 'block' }} className='home_sideNavbarTopOptionTitle'>Home</Link>
            </div>
            <div className={`home_sideNavbarTopOption`}>
                <VideocamIcon/>
        ...
        <div className='home_sideNavbarMiddle'>
            ...
            <div className={`home_sideNavbarTopOption`}>
                <SmartDisplayIcon/>
                <Link to={'/uservideo'}  style={{ textDecoration: 'none', color: 'inherit', display: 'block' }} className='home_sideNavbarTopOptionTitle'>Your videos</Link>
            </div>
            <div className={`home_sideNavbarTopOption`}>
                <WatchLaterIcon/>
