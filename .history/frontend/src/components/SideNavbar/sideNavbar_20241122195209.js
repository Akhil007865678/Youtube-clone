...
const sideNavbar = ({sideNavbar}) => {
    ...
    const handlehistory() => {
        navigate('/[eslint] 
src\components\SideNavbar\sideNavbar.js
  Line 17:22:  React Hook "useNavigate" is called in function "sideNavbar" that is neither a React function component nor a custom React Hook function. React component names must start with an uppercase letter. React Hook names must start with the word "use"  react-hooks/rules-of-hooks
    ...
    <div>
      <div className={sideNavbar ? 'home-sideNavbar' : 'homeSideNavbarHide'}>
        ...
        <div className='home_sideNavbarMiddle'>
            ...
            <div className={`home_sideNavbarTopOption`}>
                <HistoryIcon/>
                <div className='home_sideNavbarTopOptionTitle' onClick={handlehistory()}>History</div>
            </div>
            <div className={`home_sideNavbarTopOption`}>
                <PlaylistAddIcon/>
