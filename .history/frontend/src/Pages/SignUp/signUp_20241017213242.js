    ...
    <div className='signup'>
      <div className='signup_card'>
        ...
        <div className='signUp_Inputs'>
            ...
            <input type='text' className='signUp_Inputs_inp' value={signUpField.userName} onChange={(e)=>{handleInputField(e,"channelName")}} placeholder='User Name'/>
            <input type='password' className='signUp_Inputs_inp' value={signUpField.password} onChange={(e)=>{handleInputField(e,"channelName")}} placeholder='Password'/>
            <input type='text' className='signUp_Inputs_inp' value={signUpField.about} onChange={(e)=>{handleInputField(e,"channelName")}} placeholder='About Your Channel'/>
