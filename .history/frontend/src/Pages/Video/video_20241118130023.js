...
const Video = () => {
    ...
    const handleLike = (videoId, currentLike) => {
      updateLikesOrDislikes(videoId, currentLike + 1, 0);
    };
    
    const handleDislike = (videoId, currentDislike) => {
      updateLikesOrDislikes(videoId, 0, currentDislike + 1);
    };
            ...
            <div className='youtube_video_ProfileBlock'>
                ...
                <div className='youtube_video_likeBlock'>
                    <div className='youtube_video_likeBlock_like'>
                        <ThumbUpOffAltIcon/>
                        <div className='youtube_video_likeBlock_No.like' onClick={handleLike(id, data.like)}>{data?.like}</div>
                    </div>
