    ...
    const updateLikesOrDislikes = async (id, likeCount, dislikeCount) => {
      ...
      const handleLike = async (id, likeCount) => {
        try {
          ...
          console.error('Error updating likes:', error.response?.data?.message || error.message);
        }
      };
      
      const handleDislike = async (id, dislikeCount) => {
        try {
          const response = await axios.put(`http://localhost:4000/api/video/${id}/likes-dislikes`, {
            deslike: true,
          }, {
          ...
          console.error('Error updating dislikes:', error.response?.data?.message || error.message);
        }
      };      
        ...
        <div className='video_youtubeAbout'>
            ...
            <div className='youtube_video_ProfileBlock'>
                ...
                <div className='youtube_video_likeBlock'>
                    ...
                    <div className='youtube_video_likeBlock_like' onClick={() => handleDisike(id, data?.dislike)}>
                        <ThumbDownOffAltIcon/>
                    </div>
                </div>
            </div>
